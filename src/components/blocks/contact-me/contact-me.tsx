...
import ContactForm from '@/components/blocks/contact-me/contact-form'
...
const ContactMe = ({ contactInfo }: { contactInfo: ContactInfo }) => {
  return (
    <MotionPreset
      component='section'
      fade
      ...
      delay={0.15}
      className='relative border-b xl:flex'
    >
      ...
      <div className='mx-auto max-w-6xl space-y-9 px-4 py-8 min-[1147px]:border-x sm:px-6 sm:py-16 lg:px-8 lg:py-24'>
        {/* Header Section */}
          ...
          <div className='flex justify-between gap-4 max-md:flex-col'>
            <MotionPreset delay={0.3} transition={{ duration: 0.5 }} className='max-w-100'>
              <h2 className='text-2xl font-semibold sm:text-3xl lg:text-4xl'>
                <BlurText text='Start a Project 👋' delay={50} animateBy='words' direction='bottom' />
              </h2>
            </MotionPreset>
            <MotionPreset
              delay={0.3}
            ...
            >
              <p className='text-muted-foreground max-w-150 text-xl'>
                Tell us about your project. Whether you need end-to-end product development, AI integration,
                or design strategy, we&apos;re ready to help.
              </p>
            </MotionPreset>
          </div>
        </div>
