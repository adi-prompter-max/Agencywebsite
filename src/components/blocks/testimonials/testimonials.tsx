...
import ReviewStack from '@/components/blocks/testimonials/review-stack'
import type { ReviewCard } from '@/components/blocks/testimonials/review-stack'

const Testimonials = ({ reviews }: { reviews: ReviewCard[] }) => {
  return (
    <section id='testimonials' className='relative'>
      <MotionPreset fade blur transition={{ duration: 0.5 }} delay={0.15} className='relative border-y xl:flex'>
        <div className='m-6 w-full shrink-3 bg-[radial-gradient(circle_at_center,color-mix(in_oklab,var(--primary)_15%,transparent)_2px,transparent_2px)] bg-size-[18px_18px] max-xl:hidden'></div>

        <div className='mx-auto flex w-full max-w-6xl grow flex-col gap-16 px-4 py-8 min-[1147px]:border-x md:px-6 md:py-16 lg:px-8 xl:shrink-0'>
            ...
            <div className='flex justify-between gap-4 max-md:flex-col'>
              ...
              >
                <p className='text-muted-foreground max-w-xl text-xl'>
                  We&apos;re proud to partner with forward-thinking companies who trust us to handle their product
                  development end-to-end, from strategy and design to engineering and AI.
                </p>
              </MotionPreset>
            </div>
          </div>
          ...
          <div className='grid gap-9 md:grid-cols-2'>
            <div className='flex flex-col gap-8'>
              ...
              >
                We&apos;re grateful to partner with ambitious teams building the future.
              </MotionPreset>
              ...
              >
                ...
                <CraftButton asChild>
                  <Link href='/contact-me'>
                    <CraftButtonLabel>Start a Project</CraftButtonLabel>
                    <CraftButtonIcon>
